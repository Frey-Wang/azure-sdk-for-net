...
param (
  [string]$inputJsonFile="d:\\project\\azure-sdk-for-net\\eng\\automation\\generateInput.json",
...
New-PackageFolder -resourceProvider $resourceProvider -packageName $packageName -sdkPath $sdkPath -commitid $commitid
